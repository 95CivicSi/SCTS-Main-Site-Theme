<div id="coverflow" class="container featured-area">
	<div class="section-title title-font">
		<span><div><?php echo esc_html( get_theme_mod('kurama_coverflow_title',__('Featured Products','kurama')) ); ?></div></span>
	</div>
	<div class="swiper-container">
	        <div class="swiper-wrapper">
	        	 <?php
			        $args = array( 
			        	'post_type' => 'product',
			        	'posts_per_page' => esc_html( get_theme_mod('kurama_coverflow_pc',10) ), 
			        	'tax_query' => array(
								         array(
								            'taxonomy'      => 'product_cat',
								            'terms'         => esc_html( get_theme_mod('kurama_coverflow_cat',0) ),
