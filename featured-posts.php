<div id="featured-posts" class="container featured-area">
	<div class="col-md-4 col-sm-4">
	<div class="section-title title-font">
		<span><div><?php echo esc_html( get_theme_mod('kurama_a_slider_title',__('Featured Products','kurama')) ); ?></div></span>
	</div>
	    <div class="fposts-container">
	        <div class="swiper-wrapper">
	            <?php
				        $args = array( 
			        	'post_type' => 'post',
			        	'posts_per_page' => get_theme_mod('kurama_a_slider_count',10),
			        	'cat'         => esc_html( get_theme_mod('kurama_a_slider_cat',0) ),
			        	);
	...
	<div class="section-title title-font">
		<span><div><?php echo esc_html( get_theme_mod('kurama_a_box_title','Trending') ) ?></div></span>
	</div>
	    <div class="featured-grid-container">
	        <div class="fg-wrapper">
	            <?php
			        	...
			        	'post_type' => 'post',
			        	'posts_per_page' => 8, 
			        	'cat'  => esc_html( get_theme_mod('kurama_a_box_cat',0) ),
