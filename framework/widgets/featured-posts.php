...
class kurama_Featured_Posts extends WP_Widget {

	public function __construct() {
		parent::__construct(
			'kurama_fp_cat', // Base ID
			__('kurama Featured Posts by Category', 'kurama'), // Name
			array( 'description' => __( 'Display your Featured Content, with a Thumbnail.', 'kurama' ), ) // Args
		);
	}
	...
	if (isset($instance['title'])) :
		...
		<?php
         ...
         ?>
		         ...
		         <div class='fp-thumb'><a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('kurama-pop-thumb'); ?></a></div>
		         <?php 
		         else :
		         ?>
 	...
 	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'Featured Articles', 'kurama' );
		}
...
add_action( 'widgets_init', 'register_kurama_f_widget' );  
function register_kurama_f_widget() {  
    register_widget( 'kurama_Featured_Posts' );  
}  
